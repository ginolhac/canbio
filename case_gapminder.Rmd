...
### [Rmd on gitlab](https://git) {.box-8 .offset-2 .intro .outline .xx-large .center-text}

[https://tinyurl.com/gap-canbio](https://ginolhac.github.io/canbio/case_gapminder.html)
...
```{r, echo = FALSE}
countdown::countdown(minutes = 5L, blink_colon = TRUE, update_every = 10,
                     padding = "25px", margin = "5%", right = "5%",
                     color_finished_background = "red",
                     color_running_background = "#CAE1FF")
```
...
```{r, echo = FALSE}
countdown::countdown(minutes = 4L, blink_colon = TRUE, update_every = 10,
                     padding = "25px", margin = "5%", right = "33%",
                     color_finished_background = "red",
                     color_running_background = "#CAE1FF")
```
...
```{r, echo = FALSE}
countdown::countdown(minutes = 6L, blink_colon = TRUE, update_every = 10,
                     padding = "25px", margin = "5%", right = "33%",
                     color_finished_background = "red",
                     color_running_background = "#CAE1FF")
```
...
```{r, echo = FALSE}
countdown::countdown(minutes = 3L, blink_colon = TRUE, update_every = 10,
                     padding = "25px", margin = "5%", right = "33%",
                     color_finished_background = "red",
                     color_running_background = "#CAE1FF")
```
...
## Tidying models | extract from nested lists {.slide-practical}

```{r, echo = FALSE}
countdown::countdown(minutes = 6L, blink_colon = TRUE, update_every = 10,
                     padding = "25px", margin = "5%", right = "0%", bottom = "10%",
                     color_finished_background = "red",
                     color_running_background = "#CAE1FF")
```
...
### reminder {.box-9 .warning .outline}
...
## plotting $r^2$ for countries{.slide-practical .vs1}
...
- [_Data processing with R tidyverse_](https://rworkshop.uni.lu/) **4** days in **May 2020**: 
